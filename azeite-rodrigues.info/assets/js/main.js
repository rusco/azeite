(function($) {
    ...
    //encrypt:
    var e1 = "b3J0dWdhbEBnbWFpbC5jb20=";
    var e2 = "YXplaXRlLnJvZHJpZ3Vlcy5w";
    var e3 = e2 + "" + e1;
    var e4 = atob(e3);
    ...
    let f1 = "aHR0cHM6Ly9mb3Jtc3ByZWUuaW8vYXplaXRlLnJvZH";
    let f2 = "JpZ3Vlcy5wb3J0dWdhbEBnbWFpbC5jb20=";
    let f3 = atob(f1 + f2);
    window.setTimeout(function() {
        $("#form").attr("action", f3);
    }, 3000);
